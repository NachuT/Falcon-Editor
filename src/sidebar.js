...
const OPENROUTER_API_KEY = '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';
const OPENROUTER_REFERER = 'falcon-editor.vercel.app';
const OPENROUTER_TITLE = 'FalconEditor';
  ...
  try {
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        'messages': aiMessages.filter(m => m.role !== 'assistant')
      })
    });
